    ...
    return (
        <section id="home" className="container mx-auto py-16 text-center max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
                ...
                <a href="#cara-pemesanan" className="w-full sm:w-auto bg-white border-2 border-gray-800 text-gray-800 px-8 py-3 rounded-full font-medium hover:bg-gray-800 hover:text-white transition-colors text-center inline-block">
                    Cara Pemesanan
                </a>
            </div>
        </section>
